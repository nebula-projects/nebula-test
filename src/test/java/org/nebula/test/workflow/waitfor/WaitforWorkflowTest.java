...
public class WaitforWorkflowTest extends BaseTest {

  @Test
  public void test() {
    startActivityWorker(BasicActivityImpl.class, realms);

    startWorkflowWorker(WaitforWorkflowImpl.class, realms);

    WaitforWorkflowClientImpl client = new WaitforWorkflowClientImpl(
        nebulaClient, workflowProfile, realms);

    client.testWaitFor("nebula");
