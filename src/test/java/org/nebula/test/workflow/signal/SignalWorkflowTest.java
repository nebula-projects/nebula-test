...
public class SignalWorkflowTest extends BaseTest {
  ...
  public void test() {
    ...
    startWorkflowWorker(SignalWorkflowImpl.class, realms);

    SignalWorkflowClientImpl client = new SignalWorkflowClientImpl(
