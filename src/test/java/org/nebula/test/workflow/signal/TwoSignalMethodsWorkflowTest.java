...
public class TwoSignalMethodsWorkflowTest extends BaseTest {
...
//    startActivityWorker(BasicActivityImpl.class, realms);
    ...
    startWorkflowWorker(TwoSignalMethodsWorkflowImpl.class, realms);

    TwoSignalMethodsWorkflowClientImpl client = new TwoSignalMethodsWorkflowClientImpl(
