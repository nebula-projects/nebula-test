...
public class AsyncMethodWorkflowTest extends BaseTest {

  @Test
  public void test() {
    startActivityWorker(BasicActivityImpl.class, realms);

    startWorkflowWorker(AsyncMethodWorkflowImpl.class, realms);

    AsyncMethodWorkflowClientImpl client = new AsyncMethodWorkflowClientImpl(
