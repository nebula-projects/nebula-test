...
public class StartWithoutArgTest extends BaseTest {

  @Test
  public void test() {
    startActivityWorker(BasicActivityImpl.class, realms);

    startWorkflowWorker(StartWithoutArgWorkflowImpl.class, realms);

    StartWithoutArgWorkflowClientImpl client = new StartWithoutArgWorkflowClientImpl(
