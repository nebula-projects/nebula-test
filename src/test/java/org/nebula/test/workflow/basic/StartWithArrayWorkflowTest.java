...
public class StartWithArrayWorkflowTest extends BaseTest {

  @Test
  public void test() {
    startActivityWorker(BasicActivityImpl.class, realms);

    startWorkflowWorker(StartWithArrayWorkflowImpl.class, realms);

    StartWithArrayWorkflowClientImpl client = new StartWithArrayWorkflowClientImpl(
        nebulaClient, workflowProfile, realms);

    String[] names = new String[]{"nebula", "nebula-service"};
    client.test(names);
