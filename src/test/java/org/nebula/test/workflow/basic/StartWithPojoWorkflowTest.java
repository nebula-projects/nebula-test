...
public class StartWithPojoWorkflowTest extends BaseTest {

  @Test
  public void test() {
    startActivityWorker(BasicActivityImpl.class, realms);

    startWorkflowWorker(StartWithPojoWorkflowImpl.class, realms);

    StartWithPojoWorkflowClient client = new StartWithPojoWorkflowClientImpl(
