...
public class StartParallelTimerWorkflowTest extends BaseTest {
  ...
  @Test
  public void test() {
    startWorkflowWorker(StartParallelTimerWorkflowImpl.class, realms);
    ...
    assertTrue(startedInstances <= 6);

    assertTrue(completedInstances >= 3);
    assertTrue(completedInstances <= 4);
